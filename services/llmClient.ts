...
export async function streamTranslate(
  ...
  const response = await fetch("/api/translate", {
    ...
    body: JSON.stringify({ blocks, apiConfig: { baseUrl: apiConfig.baseUrl, modelName: apiConfig.modelName, glossary: apiConfig.glossary, localModel: apiConfig.localModel } }),
    signal,
  });
